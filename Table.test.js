...
describe("#insertRecord", () => {
    describe("With nonexisting table name", () => {
        ...
        test("It creates the table and adds the record", async () => {
            ...
            const { _id, ...newRecordAttributes } = await table.insertRecord(recordToInsert);

            expect(JSON.parse(fs.readFileSync("data/table.json"))).toIncludeSameMembers([
                {
                    _id,
                    ...newRecordAttributes,
                },
...
describe("#overwriteTable", () => {
    describe("With nonexisting table name", () => {
        ...
        test("It creates the table and adds the data", async () => {
            ...
            expect(JSON.parse(fs.readFileSync("data/table.json"))).toIncludeSameMembers(dataToInsert);
        });
    });
